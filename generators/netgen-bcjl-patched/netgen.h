...
long randomr(long, long);    		/* generate random integer in interval */
...
long randomr();    			/* generate random integer in interval */
...
*/
#define MAXNODES 1000000000	    		/* maximum problem sizes */
#define MAXARCS 2000000000
...
EXTERN NODE     *FROM ;	/* origin of each arc */
EXTERN NODE     *TO   ;	/* destination */
EXTERN CAPACITY *U    ;	/* capacity */
EXTERN COST     *C    ;	/* cost */
EXTERN CAPACITY *B    ;	/* supply (demand) at each node */
